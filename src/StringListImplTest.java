...
class StringListImplTest {
    ...
    void methodAddsItem() {
        stringList.add("111");
        assertTrue(stringList.contains("111"));
    }
    ...
    void methodAddsItemOnIndex() {
        ...
        assertEquals(stringList.get(1), "222");
    }
    ...
    void methodRemovesItem() {
        ...
        assertFalse(stringList.contains("222"));
    }
    ...
    void methodReturnsIndex() {
        stringList.add("111");
        assertEquals(stringList.indexOf("111"), 0);
        assertEquals(stringList.indexOf("222"), -1);
    }

    @Test
    void methodLastIndexTest() {
        stringList.add("111");
        assertEquals(stringList.lastIndexOf("111"), 0);
        assertEquals(stringList.lastIndexOf("222"), -1);
    }

    @Test
    void methodGetsElementByIndex() {
        stringList.add("111");
        assertEquals(stringList.get(0), "111");
    }
